...
Catatan: Pengguna dapat mengajukan banding atas gbans atau melaporkan spammer di @{SUPPORT_CHAT}
❂ /flood: Dapatkan pengaturan antiflood saat ini
❂ /setflood <number/off/no>: Mengatur jumlah pesan yang akan diambil tindakan pada pengguna. Setel ke '0', 'nonaktif', atau 'tidak' untuk menonaktifkan.
❂ /setfloodmode <jenis tindakan>: Pilih tindakan yang akan diambil pada pengguna yang telah membanjiri. Pilihan: ban/kick/mute/tban/tmute.
"""
